    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                ...
                <div class="user-text">
                    <h5><?php echo e(__('Total Order Amount')); ?> : <span class="text-dark text-sm"><?php echo e(\Auth::user()->priceFormat($user['total_orders_price'])); ?></span></h5>
                </div>
            </div>
            <img src="<?php echo e(asset('assets/img/dot-icon.png')); ?>" alt="" class="dotted-icon">
        </div>
        <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
            <div class="card card-box">
                <div class="left-card">
                    <div class="icon-box bg-primary"><i class="fas fa-trophy"></i></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i9finance/public_html/resources/views/dashboard/super_admin.blade.php ENDPATH**/ ?>