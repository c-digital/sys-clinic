    ...
    <div class="scrollbar-inner">
        <div class="div-mega">
            <ul class="navbar-nav navbar-nav-docs">
                ...
                <?php if(Gate::check('manage product & service')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('projects.index')); ?>" class="nav-link <?php echo e((Request::segment(1) == 'projects')?'active':''); ?>">
                            <i class="fas fa-list"></i><?php echo e(__('Projects')); ?>
                ...
                <?php if(Gate::check('manage product & service')): ?>
                    <li class="nav-item">
                        <a href="<?php echo e(route('contracts.index')); ?>" class="nav-link <?php echo e((Request::segment(1) == 'contracts')?'active':''); ?>">
                            <i class="fas fa-file"></i><?php echo e(__('Contracts')); ?>
...
<?php /**PATH /home/i9finance/public_html/resources/views/partials/admin/menu.blade.php ENDPATH**/ ?>