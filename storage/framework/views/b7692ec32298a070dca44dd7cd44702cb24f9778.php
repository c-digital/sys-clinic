...
<?php $__env->startSection('content'); ?>
    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group" id="vender-box">
                                <div class="input-group">
                                    ...
                                    <?php echo e(Form::select('vender_id', $venders,$vendorId, array('class' => 'form-control select2','id'=>'vender','data-url'=>route('bill.vender'),'required'=>'required'))); ?>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('bill_date', __('Bill Date'),['class'=>'form-control-label'])); ?>

                                        <div class="form-icon-user">
                                            <span><i class="fas fa-calendar"></i></span>
                                            <?php echo e(Form::text('bill_date', '', array('class' => 'form-control datepicker','required'=>'required'))); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('bill_number', __('Bill Number'),['class'=>'form-control-label'])); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <?php echo e(Form::label('order_number', __('Order Number'),['class'=>'form-control-label'])); ?>
        ...
        <div class="col-12 text-right">
            ...
            <input type="button" value="<?php echo e(__('Cancel')); ?>" onclick="location.href = '<?php echo e(route("bill.index")); ?>';" class="btn-create btn-xs bg-gray radius-10px">
        </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i9finance/public_html/resources/views/bill/create.blade.php ENDPATH**/ ?>