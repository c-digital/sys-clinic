                    ...
                    <div class="table-responsive">
                        <table class="table table-striped mb-0" data-repeater-list="items">
                            ...
                            <tr>
                                ...
                                <th class="text-right"><?php echo e(__('Amount')); ?> <br>
                            ...
                            <tr>
                                <td width="25%">
                                    <?php echo e(Form::select('item', $product_services,'', array('class' => 'form-control select2 item','data-url'=>route('proposal.product'),'required'=>'required'))); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/i9finance/public_html/resources/views/proposal/create.blade.php ENDPATH**/ ?>