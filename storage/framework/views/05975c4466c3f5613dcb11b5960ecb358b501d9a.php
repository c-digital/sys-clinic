                                ...
                                <div data-v-37eeda86="" class="col-33">
                                    ...
                                    <table data-v-37eeda86="" class="summary-table">
                                        ...
                                        <tr data-v-363339a0="">
                                            ...
                                            <td data-v-363339a0="" class="text-right"><?php echo e(\App\Utility::proposalNumberFormat($settings,$proposal->proposal_id)); ?></td>
                                        </tr>
                                        <tr data-v-363339a0="">
                                            <td data-v-363339a0="" class="tu fwb" style="color: <?php echo e($color); ?>;"><?php echo e(__('Issue Date')); ?>:</td>
                                            <td data-v-363339a0="" class="text-right"><?php echo e(\App\Utility::dateFormat($settings,$proposal->issue_date)); ?></td>
                                        </tr>
                                ...
                                <div data-v-37eeda86="" class="d-table">
                                    <div data-v-37eeda86="" class="d-table">
                                        ...
                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($color); ?>;">
                                            ...
                                            <div class="d-table-td w-3">
                                                <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$proposal->totalRate)); ?></pre>
                                            </div>
                                            <div class="d-table-td w-5">
                                                <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$proposal->totalTaxPrice)); ?></pre>
                                            </div>
                                            <?php if($proposal->discount_apply==1): ?>
                                                <div class="d-table-td w-2">
                                                    <pre data-v-f2a183a6=""><?php echo e(\App\Utility::priceFormat($settings,$proposal->totalDiscount)); ?></pre>
                                                </div>
                                            <?php else: ?>
                                                <div class="d-table-td w-2">
                                                    <pre data-v-f2a183a6="">-</pre>
                                            ...
                                            <div class="d-table-td w-4 text-right">
                                                    <span><?php echo e(\App\Utility::priceFormat($settings,$proposal->getSubTotal())); ?>
                                        ...
                                        <div data-v-f2a183a6="" class="d-table-footer">
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-summary">
                                                <?php if($proposal->discount_apply==1): ?>
                                                    <?php if($proposal->getTotalDiscount()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            ...
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$proposal->getTotalDiscount())); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                <?php endif; ?>
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($color); ?>; border-bottom: 1px solid <?php echo e($color); ?>;">
                                                    ...
                                                    <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::priceFormat($settings,$proposal->getSubTotal()-$proposal->getTotalDiscount()+$proposal->getTotalTax())); ?></div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH /home/i9finance/public_html/resources/views/proposal/templates/template2.blade.php ENDPATH**/ ?>